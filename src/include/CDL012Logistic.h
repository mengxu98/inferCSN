...
template <class T> class CDL012Logistic : public CD<T, CDL012Logistic<T>> {
private:
...
template <class T>
inline double
CDL012Logistic<T>::Objective(const arma::vec &expyXB,
...
template <class T> inline double CDL012Logistic<T>::Objective() {
...
template <class T> FitResult<T> CDL012Logistic<T>::_Fit() {
