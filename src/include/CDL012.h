...
template <class T> class CDL012 : public CD<T, CDL012<T>> {
private:
  double Onep2lamda2;
...
template <class T> inline double CDL012<T>::GetBiGrad(const std::size_t i) {
...
template <class T> inline double CDL012<T>::GetBiReg(const double nrb_Bi) {
...
template <class T> inline double CDL012<T>::Objective() {
...
template <class T> FitResult<T> CDL012<T>::_Fit() {
...
template <class T> FitResult<T> CDL012<T>::_FitWithBounds() {
