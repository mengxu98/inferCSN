...
template <class T> inline double CDL012SquaredHinge<T>::Objective() {
...
template <class T> FitResult<T> CDL012SquaredHinge<T>::_Fit() {
...
template <class T> FitResult<T> CDL012SquaredHinge<T>::_FitWithBounds() {
