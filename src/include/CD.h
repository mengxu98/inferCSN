...
template <class T> class CDSwaps : public CDBase<T> {
...
template <class T, class Derived> class CD : public CDBase<T> {
protected:
...
CDBase<T>::CDBase(const T &Xi, const arma::vec &yi, const Params<T> &P)
    : lambda0{P.ModelParams[0]}, lambda1{P.ModelParams[1]},
      lambda2{P.ModelParams[2]}, intercept{P.intercept},
      withBounds{P.withBounds}, y{yi}, ModelParams{P.ModelParams},
      CyclingOrder{P.CyclingOrder}, MaxIters{P.MaxIters}, rtol{P.rtol},
      atol{P.atol}, Lows{P.Lows}, Highs{P.Highs}, ActiveSet{P.ActiveSet},
...
template <class T> FitResult<T> CDBase<T>::Fit() {
  if (this->withBounds) {
...
template <class T, class Derived> bool CD<T, Derived>::isConverged() {
...
template <class T, class Derived> void CD<T, Derived>::RestrictSupport() {
...
template <class T, class Derived> bool CD<T, Derived>::CWMinCheckWithBounds() {
...
template <class T, class Derived> bool CD<T, Derived>::CWMinCheck() {
  std::vector<std::size_t> S = nnzIndicies(this->B);
