...
{
    /*
    Some code files in this package are from R package `L0Learn`: https://github.com/hazimehh/L0Learn
    I had modify some code files for my package, and fix some warning information.

    If you use this package, the code of this package, please consider citing the paper:
    @article{https://doi.org/10.1038/s41540-023-00267-8,
      title={Integration of single sample and population analysis for understanding immune evasion mechanisms of lung cancer},
      author={Xiong, Li and Xu, Meng and Haowen, Chen and Xiangzheng, Fu and Peng, Wang and Xia, Chen and Changlong, Gu and Juan, Zhou},
    ...
    and please consider citing the following papers relate `L0Learn`:
    Paper 1 (Toolkit):
